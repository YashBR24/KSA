...
//         }
//         const idt = generateRandomString(10)
...
//                 description: `ACADEMY_NEW_${name}_${roll_no}_${validatedPaymentStatus}`,
...
//             description: `PARTIAL_PAYMENT_${trainee.name}_${trainee.roll_no}`,
//             balance_before_transaction: currentBalance,
//             balance_after_transaction: newBalance,
//             method: payment_method || 'CASH',
//             identification: trainee._id,
...
router.put("/update-trainee/:id", upload.fields([
    ...
    try {
        ...
        // Check if the update involves a plan renewal (new plan_id or start_date)
        const isRenewal = (plan_id && plan_id !== existingTrainee.plan_id.toString()) ||
            (start_date && start_date !== moment(existingTrainee.from).format('YYYY-MM-DD'));

        // Generate new trans_identification for renewals
        if (isRenewal) {
            existingTrainee.trans_identification = generateRandomString(10);
        }
