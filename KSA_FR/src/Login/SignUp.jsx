...
//         <img
//           src="/Griffin_logo.png"
//           alt="Griffin Cricket Academy Logo"
//           className="w-20 h-20 mx-auto rounded-full"
//         />
//         <h1 className="text-4xl font-bold text-white">Griffin Cricket Academy</h1>
//       </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 to-indigo-600 p-4">
      <div className="text-center space-y-2">
        <img
          src="/KSA.png"
          alt="KAVYA SPORTS ACADEMY Logo"
          className="w-40 h-40"
        />
        <h1 className="text-4xl font-bold text-white">KAVYA SPORTS ACADEMY</h1>
      </div>
      <div className="w-full max-w-3xl mt-8 p-8 space-y-6 bg-white rounded-xl shadow-lg">
        <h2 className="text-2xl font-semibold text-center text-gray-800">SIGN UP</h2>
        <form onSubmit={handleSubmit} className="space-y-6">
