...
//                 { instituteId: formData.instituteId || institutes[0]?._id }, // Send instituteId if available
...
//         try {
//             const response = await axios.post(
//                 `${ip}/api/turf-admin/plans`, // Ensure this matches your backend route
//                 {}, // No body needed as per your backend example
//                 { headers: { Authorization: `Bearer ${userId}` } }
//             );
//             setPlans(response.data);
...
//             await fetchInstitutes(); // Fetch institutes on load
//         };
...
//                 {
//                     amount: booking.leftover || booking.amount, // Use leftover if partial, else full amount
//                     id: booking._id,
//                     payment_method: booking.payment_method.toUpperCase(),
...
//                             )}
//                             <div className="flex items-center text-gray-600">
//                                 <span>Institute: {booking.institute_name}</span>
//                             </div>
//                         </div>
...
// // Placeholder for renderPlans if you want to implement it
// const renderPlans = () => (
//     <div>
...
//             const response = await axios.post(
//                 `${ip}/api/turf-admin/get-all-bookings`,
//                 { userId, instituteId: selectedInstitute },
//                 { headers: { Authorization: `Bearer ${userId}` } }
//             );
//             setBookings(response.data);
//         } catch (error) {
