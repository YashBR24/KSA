...
const AccountsOverview = () => {
  ...
  const fetchAccounts = async () => {
    ...
    try {
      ...
      // Ensure we're getting an array and transform the data if needed
      let transactions = [];
      ...
      const transactionsWithBalance = transactions.map(transaction => {
        ...
        return {
          ...
          balance_after_transaction: runningBalance
        };
      });

      setAccounts(transactionsWithBalance);
      setError(null);
    ...
    return data.filter((account) => {
      ...
      const matchesDescription =
        ...
        account.description
          ...
          .includes(filters.description.toLowerCase());
      const matchesInstitute =
        !filters.institute || account.institute === filters.institute;
      let matchesDateRange = true;
      if (filters.fromDate) {
        matchesDateRange =
          new Date(account.createdAt) >= new Date(filters.fromDate);
