...
const TraineeManagement = () => {
  ...
  const getFilteredBatches = (sportId) => {
    if (!sportId) return [];
    return batches.filter((batch) => batch.sport_id && batch.sport_id._id === sportId);
  };
          ...
          <div className="bg-white rounded-xl shadow-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <DetailItem label="Batch" value={getBatchName(selectedTrainee.batch_id)} />
              </div>
            </div>
          </div>
        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        {!traineeFormData.sport_id && (
                          <p className="text-sm text-gray-500 mt-1">Please select a sport first</p>
                        )}
                      </div>
                      <div>
