  ...
  <div className="relative z-10 md:w-1/2 space-y-8 mt-8 md:mt-0">
    ...
    <div className="text-gray-700 space-y-6">
      <p className="text-base md:text-lg leading-relaxed">
        At KAVYA SPORTS ACADEMY, we are dedicated to nurturing talent, promoting sportsmanship, and providing an exceptional environment for athletes to achieve their highest potential. Our academy is a hub of excellence, where passion meets performance, and dreams take shape.
      </p>
      <p className="text-base md:text-lg leading-relaxed">
